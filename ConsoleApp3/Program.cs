...
namespace ConsoleApp3
{
    class Program
    {
        ...
        {
            Console.WriteLine("Список поддерживаемых параметров:\n - Путь к исходному каталогу (IN)" +
                "\n - Путь к каталогу назначения (OUT)\n - Интервал чтения данных (I)\n - Флаг D\n - Флаг P");
            Console.WriteLine("Введите путь к исходному каталогу (IN):");
            ...
            Console.WriteLine("Введите путь к каталогу назначения (OUT):");
            ...
            Console.WriteLine("Введите интервал чтения данных (I):");
